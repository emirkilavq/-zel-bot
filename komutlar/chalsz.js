...
let s = db.fetch(`owoh.${us.id}`)
let sa = db.fetch(`owob.${us.id}`)
let as = db.fetch(`course.${us.id}`)
let asa = db.fetch(`owo.${us.id}`)
/*let userinfo = {};
...
<a:tk3:759747152112517161> **Hunt count** : ${s || 0}
<a:tk3:759747152112517161> **Battle count** : ${sa || 0}
<a:tk3:759747152112517161> **Pray/curse count** : ${as || 0}
<a:tk3:759747152112517161> **Owo count** : ${asa || 0}
`)
